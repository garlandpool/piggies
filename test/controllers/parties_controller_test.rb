...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { canceled: @party.canceled, date: @party.date, duration: @party.duration, host_id: @party.host_id, user_id: @party.user_id }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { canceled: @party.canceled, date: @party.date, duration: @party.duration, host_id: @party.host_id, user_id: @party.user_id }
    assert_redirected_to party_path(assigns(:party))
  end
